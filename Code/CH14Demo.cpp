...
void CH14Demo::ImGUI() {
	...
	// Ajout d'un ID unique à la fenêtre
	ImGui::Begin("Chapter 14 Demo", nullptr, ImGuiWindowFlags_NoResize);
	...
	// Ajout d'un ID unique au slider
	ImGui::PushItemWidth(100);
	ImGui::SliderInt("##ParticleCount", &numParticles, 1, 300);
	ImGui::PopItemWidth();

	ImGui::SameLine();
	if (ImGui::Button("Reset##Ch14")) {
		ResetDemo();
	}
	ImGui::SameLine();
	if (ImGui::Button("Show Help##Ch14")) {
		show_help = true;
	}
	ImGui::End();
}
